...
const tracks: Track[] = [
  { id: '3', title: 'Song 10', artists: [{ id: 'b', name: 'Beta' }], album: '', genre: '', suffix: 'flac', duration: 180 },
  { id: '1', title: 'Song 2', artists: [{ id: 'a', name: 'Alpha' }], album: 'First', genre: 'Rock', duration: 240 },
